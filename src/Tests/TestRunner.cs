...
{
    // Guard against silent discovery breakage: the suite ships 133 tests
    ...
    // rules + 5 road strip/wrap + 3 road cast + 5 motel/signage). Re-pin to the exact
    // count whenever tests ship.
    private const int MinimumExpectedTests = 133;
