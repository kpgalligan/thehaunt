...
{
    // Guard against silent discovery breakage: the suite ships 165 tests
    ...
    // + 3 obstacle view + 2 item icons + 2 save v6/objects repair). Re-pin to the
    // exact count whenever tests ship.
    private const int MinimumExpectedTests = 165;
