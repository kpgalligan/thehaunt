...
{
    // Guard against silent discovery breakage: the suite ships 128 tests
    ...
    // rules + 5 road strip/wrap + 3 road cast). Re-pin to the exact count whenever tests ship.
    private const int MinimumExpectedTests = 128;
